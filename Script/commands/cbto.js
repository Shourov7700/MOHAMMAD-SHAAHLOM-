...
var id = event.senderID;
 ...
 if (event.body.indexOf("SHOUROV")==0 || (event.body.indexOf("shourov bau")==0) || event.body.indexOf("সৌরভ ভাই")==0 ||
event.body.indexOf("Shourov bai")==0 ||
event.body.indexOf("shourov dadu")==0 ||
event.body.indexOf("সৌরভ")==0 ||
event.body.indexOf("shourrov")==0 ||
event.body.indexOf("king")==0 ||
event.body.indexOf("King")==0 ||
event.body.indexOf("ceo")==0) {
