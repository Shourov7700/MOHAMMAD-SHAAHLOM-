...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "shaahlom") || (event.body.toLowerCase() == "shaahlom ") || (event.body.toLowerCase() == "king") || (event.body.toLowerCase() == "সৌরভ")) {
   ...
   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:ULLASH ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস ⃝—͟͟͞͞ 𝐂.𝐄.𝐎⸙𝐒𝐇ꫝꫝ𝐇𝐋𝐎𝐌𓆪 আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Shaahlom❤️ তাকে সবাই ⃝—͟͟͞͞ 𝐂.𝐄.𝐎⸙𝐒𝐇ꫝꫝ𝐇𝐋𝐎𝐌𓆪 নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "jerry") || (event.body.toLowerCase() == "Mim")) {
  ...
  if ((event.body.toLowerCase() == ",") || (event.body.toLowerCase() == ",")) {
     return api.sendMessage("🥰-খবরদার ওরে কেউ মেনশন দিবে না এটা আমার বস ⃝—͟͟͞͞ 𝐂.𝐄.𝐎⸙𝐒𝐇ꫝꫝ𝐇𝐋𝐎𝐌𓆪 এর ভালোবাসা And বোউ😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ami shaahl") || (event.body.toLowerCase() == "kire")) {
